...
function Home() {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 dark:text-white container mx-auto">
      ...
      <div className="flex container mx-auto mb-16 max-w-7xl">
      ...
      <div className="container grid grid-cols-4 gap-16 mx-auto max-w-7xl">
